-- Matugen dynamic theme setup and auto-reload integration
local M = {}

function M.setup()
  -- Configure base16 color schemes
...
-- Register a signal handler for SIGUSR1 to hot-reload theme updates
